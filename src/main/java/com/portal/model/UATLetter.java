...
@Entity
@Table(name = "user_acceptance_test")
public class UATLetter {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    private LocalDate letterDate;   // ✅ aligned with RequestLetter
    ...
    private String status;   // ✅ new status field (Pending, In Review, Approved, Rejected)
    ...
    public UATLetter(Long id, LocalDate letterDate, String subject,
